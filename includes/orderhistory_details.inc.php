...
WHERE n.NP_ID = :id AND n.U_ID = :userid AND n.basket = 'No'";
$stmt = $conn->prepare($query);
$stmt->bindParam(':userid', $userid); // Ensure $userid is defined
...
echo "<div class='product-details'>";
    echo "<table>";
        ...
        echo "<tr><th>Date of purchase:</th><td>" . $formattedTimestamp . "</td></tr>";
        echo "</table></div>";
    }
    echo '</div>';
}
