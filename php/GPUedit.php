...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        $query = "UPDATE gpu SET G_name = :G_name, G_price = :G_price, G_Manufacturer = :G_Manufacturer, G_PartNumber = :G_PartNumber, G_Chipset = :G_Chipset, G_Memory = :G_Memory, G_MemoryType = :G_MemoryType, G_CoreClock = :G_CoreClock, G_BoostClock = :G_BoostClock, G_Interface = :G_Interface, G_Color = :G_Color, G_FrameSync = :G_FrameSync, G_Length = :G_Length, G_TDP = :G_TDP, G_CaseExpansionSlotWidth = :G_CaseExpansionSlotWidth, G_TotalSlotWidth = :G_TotalSlotWidth, G_Cooling = :G_Cooling, G_ExternalPower = :G_ExternalPower, G_HDMIOutputs = :G_HDMIOutputs, G_DisplayPortOutputs = :G_DisplayPortOutputs, G_img = :G_img, G_active = :G_active WHERE G_ID = :G_ID";
        ...
        $statement->bindParam(':G_ID', $G_ID); // Bind GPU ID
