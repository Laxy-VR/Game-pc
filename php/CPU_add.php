...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        $C_img = $_POST['C_img'];
        $C_active = $_POST['C_active']; // Added C_active

        // Insert data into the database
        $query = "INSERT INTO cpu (C_name, C_price, C_Manufacturer, C_PartNumber, C_CoreCount, C_PerformanceCoreClock, C_PerformanceBoostClock, C_TDP, C_Series, C_Microarchitecture, C_CoreFamily, C_Socket, C_IntegratedGraphics, C_MaxSupportedMemory, C_ECCSupport, C_IncludesCooler, C_Packaging, C_PerformanceL1Cache, C_PerformanceL2Cache, C_L3Cache, C_Lithography, C_IncludesCPUCooler, C_SimultaneousMultithreading, C_img, C_active) VALUES (:C_name, :C_price, :C_Manufacturer, :C_PartNumber, :C_CoreCount, :C_PerformanceCoreClock, :C_PerformanceBoostClock, :C_TDP, :C_Series, :C_Microarchitecture, :C_CoreFamily, :C_Socket, :C_IntegratedGraphics, :C_MaxSupportedMemory, :C_ECCSupport, :C_IncludesCooler, :C_Packaging, :C_PerformanceL1Cache, :C_PerformanceL2Cache, :C_L3Cache, :C_Lithography, :C_IncludesCPUCooler, :C_SimultaneousMultithreading, :C_img, :C_active)";
        ...
        $statement->bindParam(':C_active', $C_active); // Bind C_active parameter
